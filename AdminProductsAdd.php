...
<?php
require_once "controllers/AdminsProductsAddController.php";

$AdminsProductsAddController = new AdminsProductsAddController();
...
if (isset($_POST["addProduct"])) {
    ...
    if (
        ...
        $defaultImagePath = "assets/defaultproduct.png";
        $picture = file_get_contents($defaultImagePath);
    }

    try {
        $success = $AdminsProductsAddController->addProduct(
            $product_id,
            $product_name,
            $product_price,
            $product_category,
...
<head>
  ...
  <link rel="stylesheet" href="views/adminproductadd/style.css">
  ...
  <script src="views/adminproductadd/script.js"></script>
</head>
                ...
                <div class="container-fluid">
                    <div class="card shadow" style="border: 1px solid black; margin-left: 20px; margin-right: 20px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
                        <div class="card-header" style="background: #181824">
                            <h5 class="mb-0" style="color: whitesmoke; font-size: 30px;">Add Product</h5>
                        </div>
                        <form method="post" action="" enctype="multipart/form-data">
                            <div class="card-footer border-0 py-5">
                                            ...
                                            <div class="bg-secondary-soft px-4 py-5 rounded">
                                                <div class="row g-3">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" name="product_name" class="form-control" style="font-size: 16px; border: 1px solid black;">
                                                    </div>

                                                    <div class="col-md-6">
                                                        <label class="form-label" style="font-size: 20px;">Product Price</label>
                                                        <input type="text" name="product_price" class="form-control" style="font-size: 16px; border: 1px solid black;">
                                                    </div>

                                                    <div class="col-md-12">
                                                        <label class="form-label" style="font-size: 20px;">Product Category</label>
                                                        <textarea name="product_category" class="form-control" style="font-size: 16px; border: 1px solid black;"></textarea>
                                                    </div>

                                                    <div class="col-md-12">
                                                        <label class="form-label" style="font-size: 20px;">Product Description</label>
                                                        <textarea name="product_description" class="form-control" style="font-size: 16px; border: 1px solid black;"></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-md-2">
                                                        ...
                                                        <input type="text" name="product_id" class="form-control" style="font-size: 16px; border: 1px solid black;">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <div class="overflow-hidden mx-auto mb-3" style="width: 250px; height: 340px;">
                                                            <img id="profileImage" src="assets/defaultproduct.png" alt="Profile Image" class="img-fluid" style="object-fit: cover; width: 100%; height: 100%;">
                                                        </div>
                                    ...
                                    <div class="gap-12 d-md-flex justify-content-md-left text-center mx-auto" style="padding-left: 27px">
                                        ...
                                        <button type="submit" name="addProduct" class="btn btn-lg" style="background-color: #5cb85c; color: #ffffff; margin-left: 32%">Add product</button>
