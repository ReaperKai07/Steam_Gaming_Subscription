...
<header id="header" class="header fixed-top d-flex align-items-center">
  ...
  <main id="main">
    ...
    <section id="highlight" class="highlight">
        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
          <div class="row align-items-xl-center gy-5">
            ...
            <div class="col-xl-5 content">
              <h3>Join the Gaming Membership</h3>
              <h2>Unlock Exclusive Benefits and Rewards</h2>
              <p>Level up your gaming experience! Join our membership for access to exclusive content, special events, and gaming perks. Conquer challenges, get early access of game, and explore a world of entertainment.</p>
              <a href="Membership.php" class="read-more"><span>Explore Membership</span><i class="bi bi-arrow-right"></i></a>
          </div>
            ...
            <div class="col-xl-7">
              <div class="row gy-4 icon-boxes">
                ...
                <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
                  <div class="icon-box">
                    <img src="assets/game/assassins-creed-valhalla.jpg" class="img-fluid" alt="">
                  </div>
                </div> <!-- End Icon Box -->
  
                <div class="col-md-6" data-aos="fade-up" data-aos-delay="300">
                  <div class="icon-box">
                    <img src="assets/game/GTA_5.jpg" class="img-fluid" alt="">
                  </div>
                </div> <!-- End Icon Box -->
  
                <div class="col-md-6" data-aos="fade-up" data-aos-delay="400">
                  <div class="icon-box">
                  <img src="assets/game/League_of_Legends.jpg" class="img-fluid" alt="">
                  </div>
                </div> <!-- End Icon Box -->
  
                <div class="col-md-6" data-aos="fade-up" data-aos-delay="500">
                  <div class="icon-box">
                  <img src="assets/game/Lego_Star_Wars_The_Skywalker_Saga.jpg" class="img-fluid" alt="">
                </div> <!-- End Icon Box -->
      ...
      </section><!-- End Game Highlight Section -->

      <!-- Game Slider Section -->
      <h2 style="text-align: center;"> Game Highlight </h2>
